...
- New internal feature: proper cleanup on daemon shutdown (see commit `8d24304`)
- New internal feature: exclude point-to-point interfaces by default (e.g. tunnel interface) (see commit `85b6cd9`)
