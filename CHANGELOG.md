...
* 3292110 DnsTxt debug print: make its text field human-readable (#247) (keepsimple1)
* 5567c1f Send SearchStarted events with addrs as `ip (intf-name)`  (#245) (hrzlgnm)
* 9a91a53 cache flush: add the missing timer for updated expires (#244) (keepsimple1)
* c1d7efa Change intf_socks to a map of (Interface, Socket) (#242) (keepsimple1)
* 404100d refactor out a common method for DnsRecordExt (#241) (keepsimple1)
* f055c78 Refresh A and AAAA records of active `.browse` queriers (#240) (hrzlgnm)
* 0453030 Avoid redundant query, announcement and unregistration overhaul (#239) (hrzlgnm)
