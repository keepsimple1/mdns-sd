...
This release is mostly a bugfix release, with the following feature changes:
...
* 3e6842f enable_interface: support loopback interface (#317) (keepsimple1)
* 7e77a5e fix: remove related addresses in the cache when disabling an interface (#316) (keepsimple1)
* 735fb22 refactoring: move handle_poller_events into Zeroconf impl (#315) (keepsimple1)
* e886787 ci: add doc check and fail if there are any warnings (#310) (CosminPerRam)
* 9d92545 refactoring: make e_fmt! available within the crate (#311) (keepsimple1)
* 4b671d4 ResolvedService: a new plain struct for attributes of a service (#302) (keepsimple1)
* 349de66 fix: include loopback addresses in filtering criteria (#306) (Minetake)
* 026a745 refactoring: property length check (#305) (keepsimple1)
* 818f37c TXT record: docs to remind users of the maximum length of the attribute. (#304) (Lazy Panda)
* fba8025 TxtProperties: new method to get a HashMap of properties (#303) (keepsimple1)
